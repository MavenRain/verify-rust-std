...
ownership and lifetime borrows. Its regressions use abstract `T` and symbolic
slice lengths. They do not allocate bounded backing arrays or enumerate element
types. Shared elements use `T.share`, including for interior mutable types.
...
2. Support symbolic const parameters and ownership of `[T; N]`.
